    ...
    <header className="text-white body-font">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                    <Link href={"/"} className="mr-5 text-white hover:text-white">Home</Link>
                    <Link href={"/about"} className="mr-5 text-white hover:text-white">About</Link>
                    <Link href={"/user"} className="mr-5 text-white hover:text-white">User</Link>
                    <Link href={"/contact"} className="mr-5 text-white hover:text-white">Contact</Link>
            </nav>
